      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-2 gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/solutions" className="text-slate-300 hover:text-white transition-colors duration-200">ERP Entegrasyonları</Link></li>
              <li><Link href="/solutions" className="text-slate-300 hover:text-white transition-colors duration-200">Web Uygulamaları</Link></li>
              <li><Link href="/solutions" className="text-slate-300 hover:text-white transition-colors duration-200">Mobil Çözümler</Link></li>
              <li><Link href="/solutions" className="text-slate-300 hover:text-white transition-colors duration-200">E-ticaret</Link></li>
              <li><Link href="/contact" className="text-slate-300 hover:text-white transition-colors duration-200">Mikro Destek</Link></li>
              ...
              <li><Link href="/it-consulting" className="text-slate-300 hover:text-white transition-colors duration-200">IT Danışmanlık</Link></li>
              <li><Link href="/solutions" className="text-slate-300 hover:text-white transition-colors duration-200">E-Dönüşüm</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/about" className="text-slate-300 hover:text-white transition-colors duration-200">Hakkımızda</Link></li>
              ...
              <li><Link href="/products" className="text-slate-300 hover:text-white transition-colors duration-200">Ürünler</Link></li>
