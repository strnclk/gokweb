  ...
  return (
    <section ref={ref} className="px-6 py-32 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div>
            <h3 className="text-2xl mb-4">Mikro ERP Nedir ve Neden Önemlidir?</h3>
            <p className="text-lg">
          ...
          <div>
            <h3 className="text-2xl mb-4">E-Fatura Nedir?</h3>
            <p className="text-lg">
          ...
          <div>
            <h3 className="text-2xl mb-4">E-Defter Nedir ve Avantajları</h3>
            <p className="text-lg">
          ...
          <div>
            <h3 className="text-2xl mb-4">Mikro Muhasebe Programı Özellikleri</h3>
            <p className="text-lg">
          ...
          <div>
            <h3 className="text-2xl mb-4">Neden Gökkuşağı Yazılım?</h3>
            <p className="text-lg">
              19 yılı aşkın deneyimimiz ve 500'den fazla mutlu müşterimizle, Türkiye'nin lider mikro ERP ve e-dönüşüm çözümleri sağlayıcısıyız. Mikro Fly, Mikro Run ve Mikro Jump ürünlerimiz ile her ölçekteki işletmeye özel çözümler sunuyoruz. E-fatura, e-defter ve e-arşiv sistemlerimiz tamamen yerli ve GİB onaylıdır. 7/24 uzman desteğimizle yanınızdayız.
            </p>
          </div>
        </motion.div>
      </div>
