    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-gray-50/80 to-[#F8FAFC] pt-32 md:pt-44 pb-20 lg:pb-28">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
          ...
          >
            <defs>
              {/* Soft Arch Gradient 1 - Soft Crimson to Subtle Rose Fade (Matching Fly Opacity) */}
              <linearGradient id="wowArchGrad1" x1="1440" y1="900" x2="100" y2="50" gradientUnits="userSpaceOnUse">
                ...
                <stop offset="40%" stopColor="#E11D48" stopOpacity="0.3" />
                <stop offset="75%" stopColor="#F43F5E" stopOpacity="0.18" />
                <stop offset="100%" stopColor="#FB7185" stopOpacity="0.04" />
              </linearGradient>

              {/* Soft Arch Gradient 2 - Ruby Rose Soft Glow */}
              ...
              {/* Soft Arch Gradient 3 - Subtle Red Fade */}
              ...
              {/* Arch Soft Glass Ribbon Fill (Matching Fly Softness) */}
              ...
              {/* Subtle Radial Glow from Bottom Right (Matching Fly Softness) */}
              <radialGradient id="wowOriginGlow" cx="1350" cy="850" r="800" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#DC2626" stopOpacity="0.15" />
                <stop offset="35%" stopColor="#F43F5E" stopOpacity="0.07" />
                <stop offset="70%" stopColor="#FB7185" stopOpacity="0.03" />
                <stop offset="100%" stopColor="#ffffff" stopOpacity="0" />
              </radialGradient>
            ...
            {/* Ring 1 - Primary Outer Glowing Arc */}
            <path
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-6 text-left">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gradient-to-r from-red-800/15 via-red-600/10 to-rose-500/10 border border-red-500/25 text-[#DC2626] text-xs font-semibold tracking-wide uppercase mb-6 shadow-sm"
              >
              ...
              >
                Mikro{' '}
                <span className="bg-gradient-to-r from-[#991B1B] via-[#DC2626] to-[#F43F5E] bg-clip-text text-transparent inline-block drop-shadow-sm">
                  RUN
                </span>
              </motion.h1>
              ...
              >
                <div className="relative group">
                  ...
                  <div className="absolute -inset-1 bg-gradient-to-r from-[#991B1B] via-[#DC2626] to-[#F43F5E] rounded-2xl blur-md opacity-75 group-hover:opacity-100 transition duration-500 group-hover:duration-200 animate-pulse pointer-events-none" />

                  {/* Main Eye-Catching Gradient Button */}
                  <button
                    onClick={scrollToContact}
                    className="relative inline-flex items-center justify-center gap-3.5 px-9 py-4.5 bg-gradient-to-r from-[#991B1B] via-[#DC2626] to-[#E11D48] hover:from-[#7F1D1D] hover:via-[#B91C1C] hover:to-[#BE123C] text-white rounded-xl font-bold text-lg tracking-wide shadow-xl shadow-red-600/30 hover:shadow-2xl hover:shadow-red-600/40 transition-all duration-300 transform hover:-translate-y-1 active:translate-y-0 overflow-hidden"
                  >
            ...
            <div className="lg:col-span-6 flex justify-center lg:justify-end relative">
              ...
              >
                ...
                <div className="absolute w-80 h-80 sm:w-96 sm:h-96 bg-gradient-to-tr from-[#991B1B]/25 via-[#DC2626]/20 to-[#FFF1F2]/20 rounded-full blur-3xl pointer-events-none opacity-80" />
                <div className="absolute w-64 h-64 sm:w-80 sm:h-80 bg-[#DC2626]/14 rounded-full blur-2xl pointer-events-none" />
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`bg-white/90 backdrop-blur-md rounded-2xl border border-slate-200/80 shadow-sm hover:shadow-xl hover:border-[#DC2626]/60 hover:-translate-y-1.5 transition-all duration-300 overflow-hidden flex flex-col justify-between group md:col-span-1 lg:col-span-2 ${
                    isFirstInLastCenteredRow ? 'lg:col-start-2' : ''
                  }`}
                >
                  {/* Renkli 3D Üst Vurgu Çıtası */}
                  <div className="h-1.5 w-full bg-gradient-to-r from-[#991B1B] via-[#DC2626] to-[#F43F5E]" />

                  <div className="p-7 flex flex-col justify-between flex-grow">
                    <div>
                      <div className="w-13 h-13 rounded-xl bg-gradient-to-br from-[#991B1B] via-[#DC2626] to-[#E11D48] shadow-md shadow-red-900/20 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="relative py-24 bg-gradient-to-b from-[#F8FAFC] via-red-50/30 to-[#F8FAFC] overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-rose-500/5 rounded-full blur-[150px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4 text-slate-900 tracking-tight">
              Mikro RUN <span className="bg-gradient-to-r from-[#991B1B] via-[#DC2626] to-[#F43F5E] bg-clip-text text-transparent">e-Dönüşüm Çözümleri</span>
            </h2>
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 sm:px-5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-300 transform hover:-translate-y-0.5 focus:outline-none focus-visible:outline-none focus:ring-0 select-none ${
                    isActive
                      ? 'bg-gradient-to-r from-[#991B1B] via-[#DC2626] to-[#E11D48] text-white shadow-lg shadow-red-900/20 border-0 scale-105 font-bold'
      ...
      <section className="relative py-24 bg-gradient-to-b from-[#F8FAFC] to-white overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          {/* 4 kolonlu eşit boyutlu nizami grid düzeni (12 kutu) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.4, delay: index * 0.03 }}
                className="flex items-center gap-3.5 px-5 py-4 min-h-[76px] h-full bg-white/90 backdrop-blur-md rounded-xl border border-slate-200/80 shadow-sm hover:shadow-md hover:border-[#DC2626]/60 transition-all duration-300 w-full"
              >
                <CheckCircle size={18} className="text-[#DC2626] flex-shrink-0" />
                <span className="text-slate-800 text-sm font-semibold leading-snug">{feature}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-r from-[#991B1B] via-[#DC2626] to-[#E11D48] p-10 sm:p-14 rounded-3xl text-center shadow-2xl shadow-[#DC2626]/20 relative overflow-hidden"
          >
