              ...
              <div className="relative border border-purple-200/80 bg-white/95 backdrop-blur-xl rounded-3xl p-6 sm:p-7 shadow-2xl shadow-purple-500/10">
                ...
                <div className="flex items-center justify-between border-b border-slate-100 pb-3.5 mb-4">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-bold text-slate-500">mikro-academy.portal.live</span>
                  </div>
                  <div className="px-3 py-1 bg-purple-50 border border-purple-200 rounded-full text-[11px] font-extrabold text-purple-700 flex items-center gap-1.5">
