...
export default function TeknikDestekPage() {
  ...
  const slaTiers = [
    { title: 'Kritik Sorunlar (Sistem Duruşları)', time: 'Öncelikli Destek', color: 'border-red-200 bg-red-50/50 text-red-700', desc: 'Mikro SQL veritabanı çökmesi, ağ bağlantı sorunları, e-Fatura gönderilememesi gibi iş durduran durumlar.' },
    { title: 'Orta Dereceli Sorunlar', time: 'Hızlı Müdahale', color: 'border-amber-200 bg-amber-50/50 text-amber-700', desc: 'Fatura şablonu bozulması, yeni vergi tanımı, kullanıcı yetkilendirme veya veri tabanı yavaşlama şikayetleri.' },
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl space-y-1">
                      ...
                      <div className="text-sky-700 font-bold flex items-center gap-1">
                        <CheckCircle2 size={12} /> Öncelikli Hızlı Destek
                      </div>
                    </div>
                    <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl space-y-1">
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-xs font-extrabold text-blue-600 flex items-center gap-1">
                      <CheckCircle2 size={14} /> Uzman Destek Güvencesi
                    </span>
                  </div>
