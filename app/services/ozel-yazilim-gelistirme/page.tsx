...
export default function OzelYazilimGelistirmePage() {
  ...
  return (
    <div className="min-h-screen pt-20 bg-white">
      ...
      {/* Hero Section */}
      <section className="relative py-12 md:py-20 overflow-hidden bg-gradient-to-br from-red-50/50 via-white to-red-50/30">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-6">
                ...
                <span className="bg-gradient-to-r from-red-600 via-red-700 to-red-900 bg-clip-text text-transparent">&amp; Esnek API Çözümleri</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-2.5 mb-8">
                ...
                <span className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-rose-50/90 border border-rose-200/90 rounded-xl text-rose-900 text-xs font-extrabold shadow-sm hover:scale-105 hover:bg-rose-100/80 transition-all cursor-default">
                  <span className="w-2 h-2 rounded-full bg-rose-600 animate-pulse" />
                  Esnek SQL Veri Mimarisi
                </span>
                <span className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-slate-50/90 border border-slate-200/90 rounded-xl text-slate-900 text-xs font-extrabold shadow-sm hover:scale-105 hover:bg-slate-100/80 transition-all cursor-default">
                  <span className="w-2 h-2 rounded-full bg-red-600 animate-pulse" />
                  Web &amp; Mobil Uygulama
                </span>
                <span className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-red-50/90 border border-red-200/90 rounded-xl text-red-900 text-xs font-extrabold shadow-sm hover:scale-105 hover:bg-red-100/80 transition-all cursor-default">
      ...
      <section className="py-16 bg-slate-50/70 border-y border-slate-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-7 bg-white border border-slate-200/80 rounded-3xl shadow-sm space-y-4 relative overflow-hidden">
              <div className="w-12 h-12 rounded-2xl bg-slate-100 border border-slate-200 text-slate-600 flex items-center justify-center font-bold text-lg">
                ✕
              </div>
            ...
            {techStack.map((tech, idx) => {
              ...
              return (
                <div key={idx} className="relative overflow-hidden border border-slate-200/90 rounded-2xl p-6 bg-white shadow-sm hover:shadow-xl hover:shadow-red-500/10 hover:-translate-y-2 hover:border-red-400/80 transition-all duration-300 group cursor-pointer">
                  ...
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-red-600 to-rose-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {caseStudies.map((cs, idx) => (
              <div 
                key={idx} 
                className="group relative bg-white border border-slate-200/90 hover:border-red-500/80 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:shadow-red-500/10 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between overflow-hidden"
              >
                ...
                <div>
                  <div className="w-8 h-8 rounded-xl bg-slate-50 border border-slate-200/80 text-slate-700 font-bold text-xs flex items-center justify-center mb-4 group-hover:bg-red-600 group-hover:text-white group-hover:border-red-600 transition-colors duration-300">
                    {idx + 1}
                  </div>
                  <h3 className="text-base font-extrabold text-slate-900 mb-3 group-hover:text-red-600 transition-colors duration-200">{cs.title}</h3>
      ...
      <section className="py-16 max-w-5xl mx-auto px-4 sm:px-6">
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-red-600 via-red-700 to-rose-800 text-white shadow-xl p-8 sm:p-12 md:p-16 text-center">
