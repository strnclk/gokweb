        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Gökkuşağı Yazılım olarak Üsküdar'da Mikro program, ERP ve CRM çözümleri sunuyoruz. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-2">Üsküdar Hizmeti</h3>
              <p className="text-gray-600 mb-4">Üsküdar ve çevre bölgelere yerinde kurulum ve destek.</p>
              <p className="text-gray-800 font-semibold">Tüm Üsküdar mahalleleri</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                ...
                Üsküdar'da yerinde kurulum hizmeti sunuyoruz.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-600" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                ...
                Üsküdar'daki işletmeler için özel eğitim programları.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-600" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Üsküdar'da yerinde kurulum, eğitim ve destek hizmetleri.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            ...
            Üsküdar'da yerinde demo sunumumuzdan yararlanın.
          </p>
          <a
            href="/contact"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Üsküdar ve çevre bölgelere hizmet veriyoruz:
              </p>

              <div className="grid grid-cols-2 gap-2 text-gray-700">
                <div>• Üsküdar Merkez</div>
                <div>• Kuzguncuk</div>
                <div>• Beylerbeyi</div>
                <div>• Çengelköy</div>
                <div>• Salacak</div>
                <div>• Acıbadem</div>
                <div>• Valide-i Atik</div>
                <div>• Mimar Sinan</div>
              </div>
            </div>
          </div>
