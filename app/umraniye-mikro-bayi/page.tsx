        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Gökkuşağı Yazılım olarak Ümraniye'de Mikro program, ERP ve CRM çözümleri sunuyoruz. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-2">Ümraniye Hizmeti</h3>
              <p className="text-gray-600 mb-4">Ümraniye ve çevre bölgelere yerinde kurulum ve destek.</p>
              <p className="text-gray-800 font-semibold">Tüm Ümraniye mahalleleri</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                ...
                Ümraniye'de yerinde kurulum hizmeti sunuyoruz.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-600" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                ...
                Ümraniye'deki işletmeler için özel eğitim programları.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-600" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Ümraniye'de yerinde kurulum, eğitim ve destek hizmetleri.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            ...
            Ümraniye'de yerinde demo sunumumuzdan yararlanın.
          </p>
          <a
            href="/contact"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Ümraniye ve çevre bölgelere hizmet veriyoruz:
              </p>

              <div className="grid grid-cols-2 gap-2 text-gray-700">
                <div>• Ümraniye Merkez</div>
                <div>• Karaköy</div>
                <div>• Adem Yavuz</div>
                <div>• Armağanevler</div>
                <div>• Esenler</div>
                <div>• Hekimşan</div>
                <div>• İstiklal</div>
                <div>• Tepeüstü</div>
