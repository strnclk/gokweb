        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Gökkuşağı Yazılım olarak Ataşehir'de Mikro program, ERP ve CRM çözümleri sunuyoruz. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-2">Ataşehir Merkez</h3>
              <p className="text-gray-600 mb-4">Ataşehir merkezli hizmet, tüm İstanbul'a uzaktan destek.</p>
              <p className="text-gray-800 font-semibold">Ataşehir Merkez Mahallesi</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                ...
                Ataşehir'de yerinde kurulum hizmeti sunuyoruz.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-600" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                ...
                Ataşehir'deki işletmeler için özel eğitim programları.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-5 h-5 text-green-600" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Ataşehir Merkez</h3>
              <p className="text-gray-600">
                Ataşehir merkezli hizmet, tüm İstanbul'a hızlı erişim.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            ...
            Ataşehir'deki ofisimizde sizi ağırlamaktan memnuniyet duyarız.
          </p>
          <a
            href="/contact"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 mb-4">
                Ataşehir ve çevre bölgelere hizmet veriyoruz:
              </p>

              <div className="grid grid-cols-2 gap-2 text-gray-700">
                <div>• Ataşehir Merkez</div>
                <div>• Yeni Çamlıca</div>
                <div>• Küçükbakkalköy</div>
                <div>• İçerenköy</div>
                <div>• Ferhatpaşa</div>
                <div>• Esatpaşa</div>
                <div>• Kayışdağı</div>
